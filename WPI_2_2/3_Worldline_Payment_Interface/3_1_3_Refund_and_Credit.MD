[BACK](./3_1_2_Payment.MD)
### 3.1.3 Refund and Credit
...
#### 3.1.3.1 WPI_REQUEST - list of supported input parameters
...
#### 3.1.3.2 WPI_RESPONSE - list of supported output parameters
|Field name|Description|Type|Condition|
|----------|-----------|-----------|-----------|
